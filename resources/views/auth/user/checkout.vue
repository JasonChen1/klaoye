...
<script>
    ...
    export default {
        ...
        mounted(){ 
            ...
            this.stripe = Stripe('pk_live_51J2d97FkeXjw08GhXaC9zPUcssBZbrI7qamkBgJqnsXRz666QGINAyB3WwoEEkOGFQLuFOseC7XaXz77wXBSjuhJ00cVidzmpH')
        ...
        methods:{
            getcart(){
                ...
                .then(res=>{
                    ...
                    for (const field in res.data.address) {
                        this.form[field] = res.data.address[field]
                    }
                })
                .catch(err=>{})
                .finally(res=>{
            ...
            getProdcut(query){
                ...
                .then(res=>{
                    ...
                    this.cartData[0]['product_id'] = res.data.id
                ...
                paypal.Buttons({
                    ...
                    onApprove: function(data, actions) {
                        return actions.order.capture().then(function(details) {
                            ...
                            self.form.submit('post','/api/user/paypal/checkout')
                            .then(res=>{
            ...
            checkout(){
                ...
                self.stripe.createToken(self.card).then(function(result) {
                    if (result.error) {
                        ...
                        self.form.cartData = self.cartData
                        self.form.delivery = self.selectedDelivery
                        self.form.submit('post','/api/user/checkout')
                        .then(res=>{
                            self.stripeRes = res
                            self.submitPayment()
                        })
            ...
            paymentCallback(){
                axios.post(`/api/user/stripe/callback`,this.stripeRes)
                .then(res=>{
                    this.isLoading = false
                    this.error=[]
            ...
            disErr(err){
                if(err.status===401){
                    this.toastMessage = 'Payment Fail'
                }else{
