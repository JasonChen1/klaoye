<template>
    <div class="image-magnifier" :style="style" >
        <img :width="isMobile ? '100%' :width"
             :height="isMobile ? 'auto' :height"
             :src="src"
             class="image-magnifier-img"
             ...
             :alt="imageAlt"
        />
        <div class="image-magnifier-mask" :class="isMobile? 'hide-zoomer' :'maskClass'" :style="maskStyle" ref="mask">
        </div>
        <div class="image-magnifier-zoom" :class="isMobile? 'hide-zoomer' :'zoomClass'" :style="zoomStyle" v-show="zoomShow">
